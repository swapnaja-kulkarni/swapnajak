...
NOTE: Please find the Youtube Video for Mid term project code demonstration. Thsi includes the two static redesigns and the ShinyApp Demo.
{{< video https://youtu.be/Eq7FHE7_Ls8 >}}
